...
{
    public partial class PlayFormHardMode : Form
    {
        public PlayFormHardMode()
        {
        ...
        int zombieSpeed = 5;    // var to set speed of zombies movement
        ...
        private void PlayFormHardMode_Load(object sender, EventArgs e)
        {
            //accidental click
        }
